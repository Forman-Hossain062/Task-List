...
let filterTasks = document.getElementById('filter_task');
let taskClear = document.getElementById('clear_tasks');
...
function storeInLocalStorage(val) {
    let tasks;
